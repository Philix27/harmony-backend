...
export class ApiRoutes {
	  public async AnnouncementGetOne(data: T.AnnouncementGetOneInput): Promise<T.AnnouncementGetOneResponse> {
		try {
  ...
  public async AnnouncementGetAll(data: T.AnnouncementGetAllInput): Promise<T.AnnouncementGetAllResponse> {
		try {
  ...
  public async AuthGetCredentials(data: T.AuthGetCredentialsInput): Promise<T.AuthGetCredentialsResponse> {
		try {
  ...
  public async AuthViewMembers(data: T.AuthViewMembersInput): Promise<T.AuthViewMembersResponse> {
		try {
  ...
  public async TaskEpicGetOne(data: T.TaskEpicGetOneInput): Promise<T.TaskEpicGetOneResponse> {
		try {
  ...
  public async TaskEpicGet(data: T.TaskEpicGetInput): Promise<T.TaskEpicGetResponse> {
		try {
  ...
  public async TaskStoryGetOne(data: T.TaskStoryGetOneInput): Promise<T.TaskStoryGetOneResponse> {
		try {
  ...
  public async TaskStoryGetAll(data: T.TaskStoryGetAllInput): Promise<T.TaskStoryGetAllResponse> {
		try {
  ...
  public async Task_GetOne(data: T.Task_GetOneInput): Promise<T.Task_GetOneResponse> {
		try {
  ...
  public async Task_GetAll(data: T.Task_GetAllInput): Promise<T.Task_GetAllResponse> {
		try {
  ...
  public async AnnouncementCreate(data: T.AnnouncementCreateInput): Promise<T.AnnouncementCreateResponse> {
		try {
  ...
  public async AuthCreateUser(data: T.AuthCreateUserInput): Promise<T.AuthCreateUserResponse> {
		try {
  ...
  public async AuthSendEmailOtp(data: T.AuthSendEmailOtpInput): Promise<T.AuthSendEmailOtpResponse> {
		try {
  ...
  public async AuthVerifyEmailOtp(data: T.AuthVerifyEmailOtpInput): Promise<T.AuthVerifyEmailOtpResponse> {
		try {
  ...
  public async AuthResetOtp(data: T.AuthResetOtpInput): Promise<T.AuthResetOtpResponse> {
		try {
  ...
  public async AuthLogout(data: T.AuthLogoutInput): Promise<T.AuthLogoutResponse> {
		try {
  ...
  public async AuthCreateOrg(data: T.AuthCreateOrgInput): Promise<T.AuthCreateOrgResponse> {
		try {
  ...
  public async AuthInviteMember(data: T.AuthInviteMemberInput): Promise<T.AuthInviteMemberResponse> {
		try {
  ...
  public async TaskEpicCreate(data: T.TaskEpicCreateInput): Promise<T.TaskEpicCreateResponse> {
		try {
  ...
  public async TaskStoryCreate(data: T.TaskStoryCreateInput): Promise<T.TaskStoryCreateResponse> {
		try {
  ...
  public async Task_Create(data: T.Task_CreateInput): Promise<T.Task_CreateResponse> {
		try {
  ...
  public async TeamCreate(data: T.TeamCreateInput): Promise<T.TeamCreateResponse> {
		try {
  ...
  public async TeamGetAll(data: T.TeamGetAllInput): Promise<T.TeamGetAllResponse> {
		try {
  ...
  public async TeamGetMembers(data: T.TeamGetMembersInput): Promise<T.TeamGetMembersResponse> {
		try {
  ...
  public async TeamRemove(data: T.TeamRemoveInput): Promise<T.TeamRemoveResponse> {
		try {
  ...
  public async TeamDelete(data: T.TeamDeleteInput): Promise<T.TeamDeleteResponse> {
		try {
  ...
  public async AnnouncementUpdate(data: T.AnnouncementUpdateInput): Promise<T.AnnouncementUpdateResponse> {
		try {
  ...
  public async AuthUpdateInfo(data: T.AuthUpdateInfoInput): Promise<T.AuthUpdateInfoResponse> {
		try {
  ...
  public async TaskEpicUpdate(data: T.TaskEpicUpdateInput): Promise<T.TaskEpicUpdateResponse> {
		try {
  ...
  public async TaskStoryUpdate(data: T.TaskStoryUpdateInput): Promise<T.TaskStoryUpdateResponse> {
		try {
  ...
  public async Task_Update(data: T.Task_UpdateInput): Promise<T.Task_UpdateResponse> {
		try {
  ...
  public async AnnouncementDelete(data: T.AnnouncementDeleteInput): Promise<T.AnnouncementDeleteResponse> {
		try {
  ...
  public async AuthDelete(data: T.AuthDeleteInput): Promise<T.AuthDeleteResponse> {
		try {
  ...
  public async TaskEpicDelete(data: T.TaskEpicDeleteInput): Promise<T.TaskEpicDeleteResponse> {
		try {
  ...
  public async TaskStoryDelete(data: T.TaskStoryDeleteInput): Promise<T.TaskStoryDeleteResponse> {
		try {
  ...
  public async Task_Delete(data: T.Task_DeleteInput): Promise<T.Task_DeleteResponse> {
		try {
